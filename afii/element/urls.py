...
urlpatterns = [
    url(r'^paper/space/(\d+)/$', views.all_view, name='paper_all'),
    url(r'^distribution/space/(\d+)/$', views.all_view, name='distribution_all'),
    url(r'^computer/space/(\d+)/$', views.all_view, name='computer_all'),
