# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-08 12:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='printer',
            name='space',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='printers', to='inventory.Space'),
        ),
        migrations.AddField(
            model_name='cartridge',
            name='storage',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cartridges', to='inventory.Storage'),
        ),
        migrations.AddField(
            model_name='basecartridge',
            name='base_printer',
            field=models.ManyToManyField(related_name='base_cartridges', to='inventory.BasePrinter'),
        ),
    ]
