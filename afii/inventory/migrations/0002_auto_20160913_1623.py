# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-13 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='zips', to='inventory.Storage')),
            ],
        ),
        migrations.AddField(
            model_name='printer',
